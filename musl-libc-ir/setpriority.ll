; ModuleID = 'src/misc/setpriority.c'
source_filename = "src/misc/setpriority.c"
...
define i32 @setpriority(i32 noundef %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #0 {
  ...
  %5 = zext i32 %1 to i64
  %6 = sext i32 %2 to i64
  %7 = tail call i64 asm sideeffect "syscall", "={ax},{ax},{di},{si},{dx},~{rcx},~{r11},~{memory},~{dirflag},~{fpsr},~{flags}"(i64 141, i64 %4, i64 %5, i64 %6) #2, !srcloc !3
