; ModuleID = 'src/thread/pthread_mutex_setprioceiling.c'
source_filename = "src/thread/pthread_mutex_setprioceiling.c"
...
define i32 @pthread_mutex_setprioceiling(%struct.pthread_mutex_t* noalias nocapture noundef readnone %0, i32 noundef %1, i32* noalias nocapture noundef readnone %2) local_unnamed_addr #0 {
  ret i32 22
}
