; ModuleID = 'src/string/explicit_bzero.c'
source_filename = "src/string/explicit_bzero.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nounwind strictfp
define void @explicit_bzero(i8* noundef %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i8* @memset(i8* noundef %0, i32 noundef 0, i64 noundef %1) #2
  tail call void asm sideeffect "", "r,~{memory},~{dirflag},~{fpsr},~{flags}"(i8* %3) #3, !srcloc !3
  ret void
}
