; ModuleID = 'src/process/posix_spawnattr_getsigmask.c'
source_filename = "src/process/posix_spawnattr_getsigmask.c"
...
define i32 @posix_spawnattr_getsigmask(%struct.posix_spawnattr_t* noalias nocapture noundef readonly %0, %struct.__sigset_t* noalias nocapture noundef writeonly %1) local_unnamed_addr #0 {
  %3 = getelementptr inbounds %struct.posix_spawnattr_t, %struct.posix_spawnattr_t* %0, i64 0, i32 3
