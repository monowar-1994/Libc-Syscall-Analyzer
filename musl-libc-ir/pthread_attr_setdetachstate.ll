; ModuleID = 'src/thread/pthread_attr_setdetachstate.c'
source_filename = "src/thread/pthread_attr_setdetachstate.c"
...
define i32 @pthread_attr_setdetachstate(%struct.pthread_attr_t* nocapture noundef writeonly %0, i32 noundef %1) local_unnamed_addr #0 {
  %3 = icmp ugt i32 %1, 1
  br i1 %3, label %7, label %4

4:                                                ; preds = %2
  %5 = getelementptr inbounds %struct.pthread_attr_t, %struct.pthread_attr_t* %0, i64 0, i32 0, i32 0, i64 3
