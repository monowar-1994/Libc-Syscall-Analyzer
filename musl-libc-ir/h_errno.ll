; ModuleID = 'src/network/h_errno.c'
source_filename = "src/network/h_errno.c"
...
define i32* @__h_errno_location() local_unnamed_addr #0 {
  %1 = tail call i64 asm "mov %fs:0,$0", "=r,~{dirflag},~{fpsr},~{flags}"() #1, !srcloc !3
  %2 = inttoptr i64 %1 to %struct.__pthread*
  %3 = getelementptr inbounds %struct.__pthread, %struct.__pthread* %2, i64 0, i32 15
  %4 = load i8*, i8** %3, align 8, !tbaa !4
  %5 = icmp eq i8* %4, null
  %6 = getelementptr inbounds %struct.__pthread, %struct.__pthread* %2, i64 0, i32 22
  %7 = select i1 %5, i32* @h_errno, i32* %6
  ret i32* %7
}
