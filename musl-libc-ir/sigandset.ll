; ModuleID = 'src/signal/sigandset.c'
source_filename = "src/signal/sigandset.c"
...
define i32 @sigandset(%struct.__sigset_t* nocapture noundef writeonly %0, %struct.__sigset_t* nocapture noundef readonly %1, %struct.__sigset_t* nocapture noundef readonly %2) local_unnamed_addr #0 {
