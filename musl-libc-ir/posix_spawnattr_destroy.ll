; ModuleID = 'src/process/posix_spawnattr_destroy.c'
source_filename = "src/process/posix_spawnattr_destroy.c"
...
define i32 @posix_spawnattr_destroy(%struct.posix_spawnattr_t* nocapture noundef readnone %0) local_unnamed_addr #0 {
  ret i32 0
}
