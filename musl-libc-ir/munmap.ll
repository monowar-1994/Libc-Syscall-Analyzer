; ModuleID = 'src/mman/munmap.c'
source_filename = "src/mman/munmap.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@__vm_wait = weak hidden alias void (), void ()* @dummy
@munmap = weak alias i32 (i8*, i64), i32 (i8*, i64)* @__munmap
...
define hidden i32 @__munmap(i8* noundef %0, i64 noundef %1) #1 {
  tail call void @__vm_wait() #3
  %3 = ptrtoint i8* %0 to i64
  %4 = tail call i64 asm sideeffect "syscall", "={ax},{ax},{di},{si},~{rcx},~{r11},~{memory},~{dirflag},~{fpsr},~{flags}"(i64 11, i64 %3, i64 %1) #4, !srcloc !3
