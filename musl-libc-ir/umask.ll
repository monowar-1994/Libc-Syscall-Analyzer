; ModuleID = 'src/stat/umask.c'
source_filename = "src/stat/umask.c"
...
define i32 @umask(i32 noundef %0) local_unnamed_addr #0 {
  %2 = zext i32 %0 to i64
  %3 = tail call i64 asm sideeffect "syscall", "={ax},{ax},{di},~{rcx},~{r11},~{memory},~{dirflag},~{fpsr},~{flags}"(i64 95, i64 %2) #2, !srcloc !3
