; ModuleID = 'src/misc/ptsname.c'
source_filename = "src/misc/ptsname.c"
...
define i8* @ptsname(i32 noundef %0) local_unnamed_addr #0 {
  %2 = tail call i32 @__ptsname_r(i32 noundef %0, i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @ptsname.buf, i64 0, i64 0), i64 noundef 22) #3
  %3 = icmp eq i32 %2, 0
...
6:                                                ; preds = %1, %4
  %7 = phi i8* [ null, %4 ], [ getelementptr inbounds ([22 x i8], [22 x i8]* @ptsname.buf, i64 0, i64 0), %1 ]
  ret i8* %7
}

; Function Attrs: optsize
declare hidden i32 @__ptsname_r(i32 noundef, i8* noundef, i64 noundef) local_unnamed_addr #1
