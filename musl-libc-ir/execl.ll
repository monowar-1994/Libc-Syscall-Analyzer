; ModuleID = 'src/process/execl.c'
source_filename = "src/process/execl.c"
...
define i32 @execl(i8* noundef %0, i8* noundef %1, ...) local_unnamed_addr #0 {
...
56:                                               ; preds = %48, %28
  ...
  call void @llvm.va_end(i8* nonnull %4) #5
  %59 = call i32 @execv(i8* noundef %0, i8** noundef nonnull %31) #6
...
declare i32 @execv(i8* noundef, i8** noundef) local_unnamed_addr #3
