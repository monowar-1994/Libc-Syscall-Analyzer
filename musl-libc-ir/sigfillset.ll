; ModuleID = 'src/signal/sigfillset.c'
source_filename = "src/signal/sigfillset.c"
...
define i32 @sigfillset(%struct.__sigset_t* nocapture noundef writeonly %0) local_unnamed_addr #0 {
  %2 = getelementptr inbounds %struct.__sigset_t, %struct.__sigset_t* %0, i64 0, i32 0, i64 0
  store i64 -15032385537, i64* %2, align 8, !tbaa !3
  ret i32 0
}
