; ModuleID = 'src/thread/pthread_rwlock_destroy.c'
source_filename = "src/thread/pthread_rwlock_destroy.c"
...
define i32 @pthread_rwlock_destroy(%struct.pthread_rwlock_t* nocapture noundef readnone %0) local_unnamed_addr #0 {
  ret i32 0
}
