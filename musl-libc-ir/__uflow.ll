; ModuleID = 'src/stdio/__uflow.c'
source_filename = "src/stdio/__uflow.c"
...
define protected i32 @__uflow(%struct._IO_FILE* noundef %0) local_unnamed_addr #0 {
  %2 = alloca i8, align 1
  call void @llvm.lifetime.start.p0i8(i64 1, i8* nonnull %2) #3
  %3 = tail call i32 @__toread(%struct._IO_FILE* noundef %0) #4
  %4 = icmp eq i32 %3, 0
  br i1 %4, label %5, label %13

5:                                                ; preds = %1
  %6 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %0, i64 0, i32 8
  %7 = load i64 (%struct._IO_FILE*, i8*, i64)*, i64 (%struct._IO_FILE*, i8*, i64)** %6, align 8, !tbaa !3
  %8 = call i64 %7(%struct._IO_FILE* noundef %0, i8* noundef nonnull %2, i64 noundef 1) #4
  %9 = icmp eq i64 %8, 1
