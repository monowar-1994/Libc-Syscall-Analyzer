; ModuleID = 'src/stdio/wprintf.c'
source_filename = "src/stdio/wprintf.c"
...
define i32 @wprintf(i32* noalias noundef %0, ...) local_unnamed_addr #0 {
  ...
  %5 = call i32 @vwprintf(i32* noundef %0, %struct.__va_list_tag* noundef nonnull %4) #6
...
declare i32 @vwprintf(i32* noundef, %struct.__va_list_tag* noundef) local_unnamed_addr #3
