; ModuleID = 'src/locale/__lctrans.c'
source_filename = "src/locale/__lctrans.c"
...
@__lctrans_impl = weak hidden alias i8* (i8*, %struct.__locale_map*), i8* (i8*, %struct.__locale_map*)* @dummy

; Function Attrs: mustprogress nofree norecurse nosync nounwind optsize readnone strictfp willreturn
define internal i8* @dummy(i8* noundef readnone returned %0, %struct.__locale_map* nocapture noundef readnone %1) #0 {
  ret i8* %0
}

; Function Attrs: nounwind optsize strictfp
define hidden i8* @__lctrans(i8* noundef %0, %struct.__locale_map* noundef %1) local_unnamed_addr #1 {
  %3 = tail call i8* @__lctrans_impl(i8* noundef %0, %struct.__locale_map* noundef %1) #2
  ret i8* %3
}

; Function Attrs: nounwind optsize strictfp
define hidden i8* @__lctrans_cur(i8* noundef %0) local_unnamed_addr #1 {
  %2 = tail call i64 asm "mov %fs:0,$0", "=r,~{dirflag},~{fpsr},~{flags}"() #3, !srcloc !3
  ...
  %6 = getelementptr inbounds %struct.__locale_struct, %struct.__locale_struct* %5, i64 0, i32 0, i64 5
  %7 = load %struct.__locale_map*, %struct.__locale_map** %6, align 8, !tbaa !12
  %8 = tail call i8* @__lctrans_impl(i8* noundef %0, %struct.__locale_map* noundef %7) #2
  ret i8* %8
}
