; ModuleID = 'src/signal/sigaddset.c'
source_filename = "src/signal/sigaddset.c"
...
define i32 @sigaddset(%struct.__sigset_t* nocapture noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  %3 = add nsw i32 %1, -1
  %4 = icmp ugt i32 %3, 63
  %5 = add i32 %1, -32
  %6 = icmp ult i32 %5, 3
...
10:                                               ; preds = %2
  ...
  %12 = shl nuw i64 1, %11
  %13 = getelementptr inbounds %struct.__sigset_t, %struct.__sigset_t* %0, i64 0, i32 0, i64 0
  %14 = load i64, i64* %13, align 8, !tbaa !7
  %15 = or i64 %14, %12
  store i64 %15, i64* %13, align 8, !tbaa !7
  br label %16
