; ModuleID = 'src/thread/cnd_destroy.c'
source_filename = "src/thread/cnd_destroy.c"
...
define void @cnd_destroy(%struct.cnd_t* nocapture noundef %0) local_unnamed_addr #0 {
  ret void
}
