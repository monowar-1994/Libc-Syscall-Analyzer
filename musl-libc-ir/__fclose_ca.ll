; ModuleID = 'src/stdio/__fclose_ca.c'
source_filename = "src/stdio/__fclose_ca.c"
...
define hidden i32 @__fclose_ca(%struct._IO_FILE* noundef %0) local_unnamed_addr #0 {
  %2 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %0, i64 0, i32 3
  %3 = bitcast {}** %2 to i32 (%struct._IO_FILE*)**
  %4 = load i32 (%struct._IO_FILE*)*, i32 (%struct._IO_FILE*)** %3, align 8, !tbaa !3
  %5 = tail call i32 %4(%struct._IO_FILE* noundef %0) #1
  ret i32 %5
}
