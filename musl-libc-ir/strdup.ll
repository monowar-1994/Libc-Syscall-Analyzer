; ModuleID = 'src/string/strdup.c'
source_filename = "src/string/strdup.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nounwind strictfp
define i8* @strdup(i8* noundef %0) local_unnamed_addr #0 {
  %2 = tail call i64 @strlen(i8* noundef %0) #2
  %3 = add i64 %2, 1
  %4 = tail call i8* @malloc(i64 noundef %3) #2
  %5 = icmp eq i8* %4, null
  br i1 %5, label %8, label %6

6:                                                ; preds = %1
  %7 = tail call i8* @memcpy(i8* noundef nonnull %4, i8* noundef %0, i64 noundef %3) #2
  br label %8
