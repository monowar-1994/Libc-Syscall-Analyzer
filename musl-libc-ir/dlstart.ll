; ModuleID = 'ldso/dlstart.c'
source_filename = "ldso/dlstart.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

module asm ".text "
module asm ".global _dlstart "
module asm "_dlstart: "
...
module asm "\09call _dlstart_c "

%struct.Elf64_Phdr = type { i32, i32, i64, i64, i64, i64, i64, i64 }

; Function Attrs: nounwind optsize strictfp
define hidden void @_dlstart_c(i64* noundef %0, i64* noundef %1) local_unnamed_addr #0 {
  %3 = alloca [32 x i64], align 16
  %4 = alloca [32 x i64], align 16
  %5 = bitcast [32 x i64]* %3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 256, i8* nonnull %5) #2
...
152:                                              ; preds = %148, %125
  %153 = tail call void (i8*, i64*)* asm ".hidden __dls2\0A\09lea __dls2(%rip),$0\0A", "=r,~{memory},~{dirflag},~{fpsr},~{flags}"() #2, !srcloc !16
  %154 = inttoptr i64 %99 to i8*
  tail call void %153(i8* noundef %154, i64* noundef nonnull %0) #3
  call void @llvm.lifetime.end.p0i8(i64 256, i8* nonnull %6) #2
  call void @llvm.lifetime.end.p0i8(i64 256, i8* nonnull %5) #2
  ret void
}
...
!14 = !{!"int", !5, i64 0}
!15 = !{!13, !4, i64 16}
!16 = !{i64 2147677685, i64 2147677710}
