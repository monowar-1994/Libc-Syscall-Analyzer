; ModuleID = 'src/unistd/readv.c'
source_filename = "src/unistd/readv.c"
...
define i64 @readv(i32 noundef %0, %struct.iovec* noundef %1, i32 noundef %2) local_unnamed_addr #0 {
  %4 = sext i32 %0 to i64
  %5 = ptrtoint %struct.iovec* %1 to i64
  %6 = sext i32 %2 to i64
  %7 = tail call i64 @__syscall_cp(i64 noundef 19, i64 noundef %4, i64 noundef %5, i64 noundef %6, i64 noundef 0, i64 noundef 0, i64 noundef 0) #2
