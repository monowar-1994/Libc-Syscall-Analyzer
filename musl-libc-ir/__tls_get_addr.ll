; ModuleID = 'src/thread/__tls_get_addr.c'
source_filename = "src/thread/__tls_get_addr.c"
...
define i8* @__tls_get_addr(i64* nocapture noundef readonly %0) local_unnamed_addr #0 {
  %2 = tail call i64 asm "mov %fs:0,$0", "=r,~{dirflag},~{fpsr},~{flags}"() #1, !srcloc !3
  %3 = inttoptr i64 %2 to %struct.__pthread*
  %4 = getelementptr inbounds %struct.__pthread, %struct.__pthread* %3, i64 0, i32 1
