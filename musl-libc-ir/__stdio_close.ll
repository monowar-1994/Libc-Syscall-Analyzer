; ModuleID = 'src/stdio/__stdio_close.c'
source_filename = "src/stdio/__stdio_close.c"
...
define hidden i32 @__stdio_close(%struct._IO_FILE* nocapture noundef readonly %0) local_unnamed_addr #1 {
  %2 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %0, i64 0, i32 15
  %3 = load i32, i32* %2, align 8, !tbaa !3
  %4 = tail call i32 @__aio_close(i32 noundef %3) #3
  %5 = sext i32 %4 to i64
  %6 = tail call i64 asm sideeffect "syscall", "={ax},{ax},{di},~{rcx},~{r11},~{memory},~{dirflag},~{fpsr},~{flags}"(i64 3, i64 %5) #4, !srcloc !10
