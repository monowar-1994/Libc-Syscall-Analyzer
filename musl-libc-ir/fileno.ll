; ModuleID = 'src/stdio/fileno.c'
source_filename = "src/stdio/fileno.c"
...
@fileno_unlocked = weak alias i32 (%struct._IO_FILE*), i32 (%struct._IO_FILE*)* @fileno

; Function Attrs: nounwind optsize strictfp
define i32 @fileno(%struct._IO_FILE* noundef %0) #0 {
...
5:                                                ; preds = %1
  %6 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %0, i64 0, i32 15
  %7 = load i32, i32* %6, align 8, !tbaa !10
  br label %14

8:                                                ; preds = %1
  %9 = tail call i32 @__lockfile(%struct._IO_FILE* noundef nonnull %0) #3
  %10 = icmp eq i32 %9, 0
  %11 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %0, i64 0, i32 15
