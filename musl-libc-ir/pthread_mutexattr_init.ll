; ModuleID = 'src/thread/pthread_mutexattr_init.c'
source_filename = "src/thread/pthread_mutexattr_init.c"
...
define i32 @pthread_mutexattr_init(%struct.pthread_mutexattr_t* nocapture noundef writeonly %0) local_unnamed_addr #0 {
  %2 = getelementptr inbounds %struct.pthread_mutexattr_t, %struct.pthread_mutexattr_t* %0, i64 0, i32 0
