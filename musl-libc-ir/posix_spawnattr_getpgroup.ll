; ModuleID = 'src/process/posix_spawnattr_getpgroup.c'
source_filename = "src/process/posix_spawnattr_getpgroup.c"
...
define i32 @posix_spawnattr_getpgroup(%struct.posix_spawnattr_t* noalias nocapture noundef readonly %0, i32* noalias nocapture noundef writeonly %1) local_unnamed_addr #0 {
