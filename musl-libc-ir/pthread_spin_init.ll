; ModuleID = 'src/thread/pthread_spin_init.c'
source_filename = "src/thread/pthread_spin_init.c"
...
define i32 @pthread_spin_init(i32* nocapture noundef writeonly %0, i32 noundef %1) local_unnamed_addr #0 {
