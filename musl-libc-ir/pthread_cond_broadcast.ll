; ModuleID = 'src/thread/pthread_cond_broadcast.c'
source_filename = "src/thread/pthread_cond_broadcast.c"
...
define i32 @pthread_cond_broadcast(%struct.pthread_cond_t* noundef %0) local_unnamed_addr #0 {
...
12:                                               ; preds = %7
  ...
  %16 = tail call i64 asm sideeffect "syscall", "={ax},{ax},{di},{si},{dx},~{rcx},~{r11},~{memory},~{dirflag},~{fpsr},~{flags}"(i64 202, i64 %15, i64 1, i64 2147483647) #3, !srcloc !7
  %17 = icmp eq i64 %16, -38
  br i1 %17, label %18, label %20

18:                                               ; preds = %12
  %19 = tail call i64 asm sideeffect "syscall", "={ax},{ax},{di},{si},{dx},~{rcx},~{r11},~{memory},~{dirflag},~{fpsr},~{flags}"(i64 202, i64 %15, i64 1, i64 2147483647) #3, !srcloc !7
  br label %20
