; ModuleID = 'src/malloc/calloc.c'
source_filename = "src/malloc/calloc.c"
...
define i8* @calloc(i64 noundef %0, i64 noundef %1) local_unnamed_addr #1 {
  %3 = icmp eq i64 %1, 0
...
9:                                                ; preds = %4, %2
  %10 = mul i64 %1, %0
  %11 = tail call i8* @malloc(i64 noundef %10) #6
