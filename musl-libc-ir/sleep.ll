; ModuleID = 'src/unistd/sleep.c'
source_filename = "src/unistd/sleep.c"
...
define i32 @sleep(i32 noundef %0) local_unnamed_addr #0 {
  ...
  %7 = call i32 @nanosleep(%struct.timespec* noundef nonnull %2, %struct.timespec* noundef nonnull %2) #4
  %8 = icmp eq i32 %7, 0
