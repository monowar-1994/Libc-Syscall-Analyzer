; ModuleID = 'src/complex/csinhl.c'
source_filename = "src/complex/csinhl.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nounwind optsize strictfp
define { x86_fp80, x86_fp80 } @csinhl({ x86_fp80, x86_fp80 }* nocapture noundef readonly byval({ x86_fp80, x86_fp80 }) align 16 %0) local_unnamed_addr #0 {
  ...
  %8 = tail call { double, double } @csinh(double noundef %6, double noundef %7) #4
...
declare { double, double } @csinh(double noundef, double noundef) local_unnamed_addr #1
