; ModuleID = 'src/math/tgammaf.c'
source_filename = "src/math/tgammaf.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nounwind optsize strictfp
define float @tgammaf(float noundef %0) local_unnamed_addr #0 {
  %2 = tail call double @llvm.experimental.constrained.fpext.f64.f32(float %0, metadata !"fpexcept.ignore") #3
  %3 = tail call double @tgamma(double noundef %2) #4
  %4 = tail call float @llvm.experimental.constrained.fptrunc.f32.f64(double %3, metadata !"round.dynamic", metadata !"fpexcept.ignore") #3
  ret float %4
}
