; ModuleID = 'src/math/sinl.c'
source_filename = "src/math/sinl.c"
...
29:                                               ; preds = %16
  %30 = tail call x86_fp80 @llvm.experimental.constrained.fpext.f80.f64(double 0.000000e+00, metadata !"fpexcept.ignore") #5
...
39:                                               ; preds = %32
  %40 = call x86_fp80 @__sinl(x86_fp80 noundef %35, x86_fp80 noundef %37, i32 noundef 1) #6
  br label %50

41:                                               ; preds = %32
  %42 = call x86_fp80 @__cosl(x86_fp80 noundef %35, x86_fp80 noundef %37) #6
  br label %50

43:                                               ; preds = %32
  %44 = call x86_fp80 @__sinl(x86_fp80 noundef %35, x86_fp80 noundef %37, i32 noundef 1) #6
  %45 = fneg x86_fp80 %44
  br label %50
...
47:                                               ; preds = %32
  %48 = call x86_fp80 @__cosl(x86_fp80 noundef %35, x86_fp80 noundef %37) #6
  %49 = fneg x86_fp80 %48
  br label %50

50:                                               ; preds = %47, %43, %41, %39, %29, %26, %10
  %51 = phi x86_fp80 [ %11, %10 ], [ %0, %26 ], [ %31, %29 ], [ %49, %47 ], [ %45, %43 ], [ %42, %41 ], [ %40, %39 ]
