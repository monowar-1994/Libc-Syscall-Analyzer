; ModuleID = 'src/signal/sigisemptyset.c'
source_filename = "src/signal/sigisemptyset.c"
...
define i32 @sigisemptyset(%struct.__sigset_t* nocapture noundef readonly %0) local_unnamed_addr #0 {
