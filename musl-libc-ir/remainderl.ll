; ModuleID = 'src/math/x86_64/remainderl.c'
source_filename = "src/math/x86_64/remainderl.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nofree nosync nounwind optsize readnone strictfp
define x86_fp80 @remainderl(x86_fp80 noundef %0, x86_fp80 noundef %1) local_unnamed_addr #0 {
  br label %3

3:                                                ; preds = %3, %2
  %4 = phi x86_fp80 [ %0, %2 ], [ %6, %3 ]
  %5 = tail call { x86_fp80, i16 } asm "fprem1; fnstsw %ax", "={st},={ax},{st(1)},0,~{dirflag},~{fpsr},~{flags}"(x86_fp80 %1, x86_fp80 %4) #1, !srcloc !3
