; ModuleID = 'src/thread/pthread_getschedparam.c'
source_filename = "src/thread/pthread_getschedparam.c"
...
define i32 @pthread_getschedparam(%struct.__pthread* noundef %0, i32* noalias nocapture noundef writeonly %1, %struct.sched_param* noalias noundef %2) local_unnamed_addr #0 {
...
10:                                               ; preds = %3
  ...
  %12 = ptrtoint %struct.sched_param* %2 to i64
  %13 = call i64 asm sideeffect "syscall", "={ax},{ax},{di},{si},~{rcx},~{r11},~{memory},~{dirflag},~{fpsr},~{flags}"(i64 143, i64 %11, i64 %12) #3, !srcloc !11
...
17:                                               ; preds = %10
  ...
  %20 = call i64 asm sideeffect "syscall", "={ax},{ax},{di},~{rcx},~{r11},~{memory},~{dirflag},~{fpsr},~{flags}"(i64 145, i64 %19) #3, !srcloc !12
  %21 = trunc i64 %20 to i32
  store i32 %21, i32* %1, align 4, !tbaa !13
  br label %22

22:                                               ; preds = %3, %10, %17
  %23 = phi i32 [ %15, %10 ], [ 0, %17 ], [ 3, %3 ]
