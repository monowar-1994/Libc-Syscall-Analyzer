; ModuleID = 'src/string/wcscat.c'
source_filename = "src/string/wcscat.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nounwind strictfp
define i32* @wcscat(i32* noalias noundef returned %0, i32* noalias noundef %1) local_unnamed_addr #0 {
  %3 = tail call i64 @wcslen(i32* noundef %0) #2
  %4 = getelementptr inbounds i32, i32* %0, i64 %3
  %5 = tail call i32* @wcscpy(i32* noundef %4, i32* noundef %1) #2
  ret i32* %0
}
