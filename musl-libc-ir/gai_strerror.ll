; ModuleID = 'src/network/gai_strerror.c'
source_filename = "src/network/gai_strerror.c"
...
define i8* @gai_strerror(i32 noundef %0) local_unnamed_addr #0 {
  %2 = add nsw i32 %0, 1
  %3 = icmp eq i32 %2, 0
...
4:                                                ; preds = %1, %14
  %5 = phi i32 [ %16, %14 ], [ %2, %1 ]
  %6 = phi i8* [ %15, %14 ], [ getelementptr inbounds ([239 x i8], [239 x i8]* @msgs, i64 0, i64 0), %1 ]
...
18:                                               ; preds = %4, %14, %1
  %19 = phi i8* [ getelementptr inbounds ([239 x i8], [239 x i8]* @msgs, i64 0, i64 0), %1 ], [ %15, %14 ], [ %6, %4 ]
