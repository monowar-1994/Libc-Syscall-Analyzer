; ModuleID = 'src/thread/pthread_mutexattr_destroy.c'
source_filename = "src/thread/pthread_mutexattr_destroy.c"
...
define i32 @pthread_mutexattr_destroy(%struct.pthread_mutexattr_t* nocapture noundef readnone %0) local_unnamed_addr #0 {
  ret i32 0
}
