; ModuleID = 'src/thread/pthread_barrierattr_destroy.c'
source_filename = "src/thread/pthread_barrierattr_destroy.c"
...
define i32 @pthread_barrierattr_destroy(%struct.pthread_barrierattr_t* nocapture noundef readnone %0) local_unnamed_addr #0 {
  ret i32 0
}
