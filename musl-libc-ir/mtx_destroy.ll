; ModuleID = 'src/thread/mtx_destroy.c'
source_filename = "src/thread/mtx_destroy.c"
...
define void @mtx_destroy(%struct.mtx_t* nocapture noundef %0) local_unnamed_addr #0 {
  ret void
}
