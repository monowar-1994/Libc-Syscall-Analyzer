; ModuleID = 'src/stdio/rewind.c'
source_filename = "src/stdio/rewind.c"
...
define void @rewind(%struct._IO_FILE* noundef %0) local_unnamed_addr #0 {
...
5:                                                ; preds = %1
  %6 = tail call i32 @__lockfile(%struct._IO_FILE* noundef nonnull %0) #2
  %7 = icmp eq i32 %6, 0
  %8 = tail call i32 @__fseeko_unlocked(%struct._IO_FILE* noundef nonnull %0, i64 noundef 0, i32 noundef 0) #2
  %9 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %0, i64 0, i32 0
  %10 = load i32, i32* %9, align 8, !tbaa !10
  %11 = and i32 %10, -33
  store i32 %11, i32* %9, align 8, !tbaa !10
...
13:                                               ; preds = %1
  %14 = tail call i32 @__fseeko_unlocked(%struct._IO_FILE* noundef nonnull %0, i64 noundef 0, i32 noundef 0) #2
  %15 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %0, i64 0, i32 0
  %16 = load i32, i32* %15, align 8, !tbaa !10
  %17 = and i32 %16, -33
  store i32 %17, i32* %15, align 8, !tbaa !10
  br label %18
...
; Function Attrs: optsize
declare hidden i32 @__fseeko_unlocked(%struct._IO_FILE* noundef, i64 noundef, i32 noundef) local_unnamed_addr #1
