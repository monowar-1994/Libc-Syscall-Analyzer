; ModuleID = 'src/string/strchr.c'
source_filename = "src/string/strchr.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nounwind strictfp
define i8* @strchr(i8* noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i8* @__strchrnul(i8* noundef %0, i32 noundef %1) #2
  %4 = load i8, i8* %3, align 1, !tbaa !3
  %5 = trunc i32 %1 to i8
  %6 = icmp eq i8 %4, %5
  %7 = select i1 %6, i8* %3, i8* null
  ret i8* %7
}
