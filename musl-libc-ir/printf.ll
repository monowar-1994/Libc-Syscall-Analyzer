...
define i32 @printf(i8* noalias noundef %0, ...) local_unnamed_addr #0 {
  ...
  %5 = call i32 @vfprintf(%struct._IO_FILE* noundef nonnull @__stdout_FILE, i8* noundef %0, %struct.__va_list_tag* noundef nonnull %4) #6
