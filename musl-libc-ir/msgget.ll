; ModuleID = 'src/ipc/msgget.c'
source_filename = "src/ipc/msgget.c"
...
define i32 @msgget(i32 noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  %3 = sext i32 %0 to i64
  %4 = sext i32 %1 to i64
  %5 = tail call i64 asm sideeffect "syscall", "={ax},{ax},{di},{si},~{rcx},~{r11},~{memory},~{dirflag},~{fpsr},~{flags}"(i64 68, i64 %3, i64 %4) #2, !srcloc !3
