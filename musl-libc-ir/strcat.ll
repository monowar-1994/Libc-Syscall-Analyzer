; ModuleID = 'src/string/strcat.c'
source_filename = "src/string/strcat.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nounwind strictfp
define i8* @strcat(i8* noalias noundef returned %0, i8* noalias noundef %1) local_unnamed_addr #0 {
  %3 = tail call i64 @strlen(i8* noundef %0) #2
  %4 = getelementptr inbounds i8, i8* %0, i64 %3
  %5 = tail call i8* @strcpy(i8* noundef %4, i8* noundef %1) #2
  ret i8* %0
}
