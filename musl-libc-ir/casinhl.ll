; ModuleID = 'src/complex/casinhl.c'
source_filename = "src/complex/casinhl.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nounwind optsize strictfp
define { x86_fp80, x86_fp80 } @casinhl({ x86_fp80, x86_fp80 }* nocapture noundef byval({ x86_fp80, x86_fp80 }) align 16 %0) local_unnamed_addr #0 {
  ...
  %10 = tail call { x86_fp80, x86_fp80 } @casinl({ x86_fp80, x86_fp80 }* noundef nonnull byval({ x86_fp80, x86_fp80 }) align 16 %2) #2
