; ModuleID = 'src/signal/sigprocmask.c'
source_filename = "src/signal/sigprocmask.c"
...
define i32 @sigprocmask(i32 noundef %0, %struct.__sigset_t* noalias noundef %1, %struct.__sigset_t* noalias noundef %2) local_unnamed_addr #0 {
  %4 = tail call i32 @pthread_sigmask(i32 noundef %0, %struct.__sigset_t* noundef %1, %struct.__sigset_t* noundef %2) #3
  %5 = icmp eq i32 %4, 0
...
declare i32 @pthread_sigmask(i32 noundef, %struct.__sigset_t* noundef, %struct.__sigset_t* noundef) local_unnamed_addr #1
