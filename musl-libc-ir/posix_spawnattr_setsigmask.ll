; ModuleID = 'src/process/posix_spawnattr_setsigmask.c'
source_filename = "src/process/posix_spawnattr_setsigmask.c"
...
define i32 @posix_spawnattr_setsigmask(%struct.posix_spawnattr_t* noalias nocapture noundef writeonly %0, %struct.__sigset_t* noalias nocapture noundef readonly %1) local_unnamed_addr #0 {
