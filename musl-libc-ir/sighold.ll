; ModuleID = 'src/signal/sighold.c'
source_filename = "src/signal/sighold.c"
...
7:                                                ; preds = %1
  %8 = call i32 @sigprocmask(i32 noundef 0, %struct.__sigset_t* noundef nonnull %2, %struct.__sigset_t* noundef null) #4
  br label %9
