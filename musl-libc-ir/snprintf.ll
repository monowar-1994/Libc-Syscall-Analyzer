; ModuleID = 'src/stdio/snprintf.c'
source_filename = "src/stdio/snprintf.c"
...
define i32 @snprintf(i8* noalias noundef %0, i64 noundef %1, i8* noalias noundef %2, ...) local_unnamed_addr #0 {
  ...
  %7 = call i32 @vsnprintf(i8* noundef %0, i64 noundef %1, i8* noundef %2, %struct.__va_list_tag* noundef nonnull %6) #6
