; ModuleID = 'src/thread/pthread_condattr_destroy.c'
source_filename = "src/thread/pthread_condattr_destroy.c"
...
define i32 @pthread_condattr_destroy(%struct.pthread_condattr_t* nocapture noundef readnone %0) local_unnamed_addr #0 {
  ret i32 0
}
