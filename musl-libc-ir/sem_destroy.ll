; ModuleID = 'src/thread/sem_destroy.c'
source_filename = "src/thread/sem_destroy.c"
...
define i32 @sem_destroy(%struct.sem_t* nocapture noundef readnone %0) local_unnamed_addr #0 {
  ret i32 0
}
