; ModuleID = 'src/thread/pthread_rwlockattr_destroy.c'
source_filename = "src/thread/pthread_rwlockattr_destroy.c"
...
define i32 @pthread_rwlockattr_destroy(%struct.pthread_rwlockattr_t* nocapture noundef readnone %0) local_unnamed_addr #0 {
  ret i32 0
}
