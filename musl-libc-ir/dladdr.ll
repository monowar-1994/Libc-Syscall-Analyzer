; ModuleID = 'src/ldso/dladdr.c'
source_filename = "src/ldso/dladdr.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%struct.Dl_info = type { i8*, i8*, i8*, i8* }

@dladdr = weak alias i32 (i8*, %struct.Dl_info*), i32 (i8*, %struct.Dl_info*)* @stub_dladdr

; Function Attrs: mustprogress nofree norecurse nosync nounwind optsize readnone strictfp willreturn
define internal i32 @stub_dladdr(i8* nocapture noundef readnone %0, %struct.Dl_info* nocapture noundef readnone %1) #0 {
  ret i32 0
}
