; ModuleID = 'src/math/log2f.c'
source_filename = "src/math/log2f.c"
...
@__log2f_data = external hidden local_unnamed_addr constant %struct.log2f_data, align 8

; Function Attrs: nounwind optsize strictfp
define float @log2f(float noundef %0) local_unnamed_addr #0 {
...
26:                                               ; preds = %22, %6
  ...
  %35 = getelementptr inbounds %struct.log2f_data, %struct.log2f_data* @__log2f_data, i64 0, i32 0, i64 %34, i32 0
  %36 = load double, double* %35, align 8, !tbaa !4
  %37 = getelementptr inbounds %struct.log2f_data, %struct.log2f_data* @__log2f_data, i64 0, i32 0, i64 %34, i32 1
  ...
  %44 = tail call double @llvm.experimental.constrained.sitofp.f64.i32(i32 %33, metadata !"round.dynamic", metadata !"fpexcept.ignore") #3
  %45 = tail call double @llvm.experimental.constrained.fadd.f64(double %38, double %44, metadata !"round.dynamic", metadata !"fpexcept.ignore") #3
  %46 = tail call double @llvm.experimental.constrained.fmul.f64(double %43, double %43, metadata !"round.dynamic", metadata !"fpexcept.ignore") #3
  %47 = load double, double* getelementptr inbounds (%struct.log2f_data, %struct.log2f_data* @__log2f_data, i64 0, i32 1, i64 1), align 8, !tbaa !10
  %48 = load double, double* getelementptr inbounds (%struct.log2f_data, %struct.log2f_data* @__log2f_data, i64 0, i32 1, i64 2), align 8, !tbaa !10
  %49 = tail call double @llvm.experimental.constrained.fmuladd.f64(double %47, double %43, double %48, metadata !"round.dynamic", metadata !"fpexcept.ignore") #3
  %50 = load double, double* getelementptr inbounds (%struct.log2f_data, %struct.log2f_data* @__log2f_data, i64 0, i32 1, i64 0), align 8, !tbaa !10
  %51 = tail call double @llvm.experimental.constrained.fmuladd.f64(double %50, double %46, double %49, metadata !"round.dynamic", metadata !"fpexcept.ignore") #3
  %52 = load double, double* getelementptr inbounds (%struct.log2f_data, %struct.log2f_data* @__log2f_data, i64 0, i32 1, i64 3), align 8, !tbaa !10
  %53 = tail call double @llvm.experimental.constrained.fmuladd.f64(double %52, double %43, double %45, metadata !"round.dynamic", metadata !"fpexcept.ignore") #3
  %54 = tail call double @llvm.experimental.constrained.fmuladd.f64(double %51, double %46, double %53, metadata !"round.dynamic", metadata !"fpexcept.ignore") #3
