; ModuleID = 'src/math/x86_64/rintl.c'
source_filename = "src/math/x86_64/rintl.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nofree nosync nounwind optsize readnone strictfp
define x86_fp80 @rintl(x86_fp80 noundef %0) local_unnamed_addr #0 {
  %2 = tail call x86_fp80 asm "frndint", "={st},0,~{dirflag},~{fpsr},~{flags}"(x86_fp80 %0) #1, !srcloc !3
  ret x86_fp80 %2
}
