; ModuleID = 'src/string/wcspbrk.c'
source_filename = "src/string/wcspbrk.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nounwind strictfp
define i32* @wcspbrk(i32* noundef %0, i32* noundef %1) local_unnamed_addr #0 {
  %3 = tail call i64 @wcscspn(i32* noundef %0, i32* noundef %1) #2
  %4 = getelementptr inbounds i32, i32* %0, i64 %3
  %5 = load i32, i32* %4, align 4, !tbaa !3
  %6 = icmp eq i32 %5, 0
  %7 = select i1 %6, i32* null, i32* %4
  ret i32* %7
}
